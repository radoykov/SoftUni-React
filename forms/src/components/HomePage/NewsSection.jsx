        ...
        <div className="container">
            <div className="row">
                ...
                <div className="col-lg-4 col-12 mx-auto">
                    <form onSubmit={onSearch} className="custom-form search-form" method="get" role="form">
                        <input name="search" type="search" className="form-control" id="search" placeholder="Search"
                            aria-label="Search" />
                    ...
                    <form onSubmit={onSubmit} className="custom-form subscribe-form" method="get" role="form">
