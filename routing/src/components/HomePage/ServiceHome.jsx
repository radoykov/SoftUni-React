                ...
                <div className="col-md-12">
                    <ul className="nav d-flex justify-content-center">
                        <li className="nav-item mx-lg-4">
                            <Link className="filter-btn nav-link btn-outline-primary active shadow rounded-pill text-light px-4 light-300" to="/home/all" data-filter=".project">All</Link>
                        </li>
                        <li className="nav-item mx-lg-4">
                            <Link className="filter-btn nav-link btn-outline-primary rounded-pill text-light px-4 light-300" to="/home/graphics" data-filter=".graphic">Graphics</Link>
                        </li>
                        <li className="filter-btn nav-item mx-lg-4">
                            <Link className="filter-btn nav-link btn-outline-primary rounded-pill text-light px-4 light-300" to="/home/ui&ux" data-filter=".ui">UI/UX</Link>
                        </li>
                        <li className="nav-item mx-lg-4">
                            <Link className="filter-btn nav-link btn-outline-primary rounded-pill text-light px-4 light-300" to="/home/branding" data-filter=".branding">Branding</Link>
                        </li>
                    </ul>
                </div>
            </div>
